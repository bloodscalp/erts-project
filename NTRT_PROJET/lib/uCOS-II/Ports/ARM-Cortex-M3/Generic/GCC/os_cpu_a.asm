...
#
#
#                                        ARM Cortex-M3 Port (GCC)
#
# File      : OS_CPU_A.ASM
# Version   : V1.0
# By        : Xavier Meyer
# Misc.     : This script is an adapted version of the IAR script from the Micrium port
#
...
.set NVIC_SYSPRI14,   0xE000ED22                              @ System priority register (priority 14).
.set NVIC_PENDSV_PRI, 0xFF                                    @ PendSV priority value (lowest).
